...
export interface Typegen0 {
  ...
  internalEvents: {
    '': { type: '' };
    'done.invoke.(machine).chips.adding:invocation[0]': {
      type: 'done.invoke.(machine).chips.adding:invocation[0]';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
    'done.invoke.(machine).menu.adding:invocation[0]': {
      type: 'done.invoke.(machine).menu.adding:invocation[0]';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
    'done.invoke.(machine).search.searching:invocation[0]': {
      type: 'done.invoke.(machine).search.searching:invocation[0]';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
  ...
  eventsCausingActions: {
    ...
    blurInput: 'KEY_PRESS';
    cancelSearch: 'SEARCH';
    clearInput: 'ADD' | 'KEY_PRESS';
    deletePerson: 'DELETE';
    deleteSelectedPerson: 'KEY_PRESS';
    focusInput: 'ADD' | 'DELETE' | 'KEY_PRESS';
    moveLeft: 'KEY_PRESS';
    moveRight: 'KEY_PRESS';
