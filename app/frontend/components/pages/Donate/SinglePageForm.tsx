...
export const Form: React.FC = () => {
  ...
  const amount = form.useStore((state) => state.values.amount);

  return (
    <Elements stripe={stripe} options={{ mode: 'payment', amount, currency: 'nzd' }}>
      <Grid asChild className={styles.form}>
        ...
        >
          <Text as="div" className={styles.intro} size={size}>
            ...
            <Heading size={{ initial: '6', md: '8' }}>Donate to NZIF</Heading>
            <p>
              We do our best to keep costs down, because we believe that NZIF should be for
              everyone.
            </p>
            <p>
              However, the increasingly competitive arts funding landscape has meant that for the
              past three years we have received no funding from Creative New Zealand, and we’re
