...
export type Registration = {
  ...
  person: Person;
  phone: Maybe<Scalars['String']>;
  preferences: Array<WorkshopSlot>;
  pronouns: Maybe<Scalars['String']>;
  user: User;
};
...
export type RegistrationQuery = { __typename: 'Query', registration: { __typename: 'Registration', id: string, codeOfConductAcceptedAt: DateTime | null, user: { __typename: 'User', id: string, email: string }, person: { __typename: 'Person', id: string, name: string, pronouns: string | null, phone: string | null, city: { __typename: 'PlaceName', id: string, name: string, traditionalName: string | null } | null, country: { __typename: 'PlaceName', id: string, name: string, traditionalName: string | null } | null }, preferences: Array<{ __typename: 'WorkshopSlot', id: string, startsAt: DateTime, endsAt: DateTime, workshops: Array<{ __typename: 'Workshop', id: string, name: string }> }> }, festival: { __typename: 'Festival', id: string, startDate: DateTime, endDate: DateTime, workshopSlots: Array<{ __typename: 'WorkshopSlot', id: string, startsAt: DateTime, endsAt: DateTime, workshops: Array<{ __typename: 'Workshop', id: string, type: ActivityType, name: string, slug: string, picture: { __typename: 'ActivityPicture', id: string, medium: string, blurhash: string } | null, tutors: Array<{ __typename: 'Person', id: string, name: string, city: { __typename: 'PlaceName', id: string, name: string, traditionalName: string | null } | null, country: { __typename: 'PlaceName', id: string, name: string, traditionalName: string | null } | null }> }> }> } };
