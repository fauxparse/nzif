...
export type AdminActivitySessionDetailsFragment = { __typename: 'Session', id: string, startsAt: DateTime, endsAt: DateTime, capacity: number | null, participants: Array<{ __typename: 'Registration', id: string, user: { __typename: 'User', id: string, profile: { __typename: 'Person', id: string, name: string } | null } | null }>, waitlist: Array<{ __typename: 'Registration', id: string, user: { __typename: 'User', id: string, profile: { __typename: 'Person', id: string, name: string } | null } | null }>, venue: { __typename: 'Venue', id: string, room: string | null, building: string } | null };
