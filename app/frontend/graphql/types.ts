...
export type ActivitySearchQuery = { __typename: 'Query', search: Array<{ __typename: 'ActivityResult', id: string, title: string, description: string | null, url: string, activity: { __typename: 'Show', id: string, type: ActivityType, name: string, slug: string } | { __typename: 'SocialEvent', id: string, type: ActivityType, name: string, slug: string } | { __typename: 'Workshop', id: string, type: ActivityType, name: string, slug: string } } | { __typename: 'PageResult', id: string, title: string, description: string | null, url: string } | { __typename: 'PersonResult', id: string, title: string, description: string | null, url: string } | { __typename: 'VenueResult', id: string, title: string, description: string | null, url: string }> };
...
export type CreateActivityMutation = { __typename: 'Mutation', createActivity: { __typename: 'CreateActivityPayload', activity: { __typename: 'Show', id: string, type: ActivityType, name: string, slug: string } | { __typename: 'SocialEvent', id: string, type: ActivityType, name: string, slug: string } | { __typename: 'Workshop', id: string, type: ActivityType, name: string, slug: string }, slot: { __typename: 'Slot', id: string, startsAt: DateTime, endsAt: DateTime, activityType: ActivityType, activity: { __typename: 'Show', id: string, type: ActivityType, name: string, slug: string } | { __typename: 'SocialEvent', id: string, type: ActivityType, name: string, slug: string } | { __typename: 'Workshop', id: string, type: ActivityType, name: string, slug: string } | null, venue: { __typename: 'Venue', id: string, room: string | null, building: string, position: number } | null } | null } | null };

type TimetableActivity_Show_Fragment = { __typename: 'Show', id: string, type: ActivityType, name: string, slug: string };

type TimetableActivity_SocialEvent_Fragment = { __typename: 'SocialEvent', id: string, type: ActivityType, name: string, slug: string };

type TimetableActivity_Workshop_Fragment = { __typename: 'Workshop', id: string, type: ActivityType, name: string, slug: string };
