...
export type MergeProfilesPayload = {
  __typename: 'MergeProfilesPayload';
  /** The merged profile */
  profile: Person;
};
...
export type Mutation = {
  ...
  mergeProfiles: Maybe<MergeProfilesPayload>;
  /** Move an activity */
...
/** Attributes for merging profiles */
...
export type MergeProfilesMutation = { __typename: 'Mutation', mergeProfiles: { __typename: 'MergeProfilesPayload', profile: { __typename: 'Person', id: string, name: string, pronouns: string | null, user: { __typename: 'User', id: string, email: string } | null, city: { __typename: 'PlaceName', id: string, name: string, traditionalName: string | null } | null, country: { __typename: 'PlaceName', id: string, name: string, traditionalName: string | null } | null, picture: { __typename: 'ProfilePicture', id: string, small: string, large: string } | null } } | null };
