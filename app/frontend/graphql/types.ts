...
export type AddVoucherMutation = { __typename: 'Mutation', addVoucher: { __typename: 'AddVoucherPayload', voucher: { __typename: 'Voucher', id: string, workshops: number, amount: number } } | null };
