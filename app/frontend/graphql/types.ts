...
export type SaveFeedbackMutation = { __typename: 'Mutation', saveFeedback: { __typename: 'SaveFeedbackPayload', feedback: { __typename: 'Feedback', id: string, rating: number | null, positive: string, constructive: string, testimonial: string, session: { __typename: 'Session', id: string } } } | null };
