...
type AdminActivityDetails_Show_Fragment = { __typename: 'Show', bookingLink: string | null, id: string, name: string, type: ActivityType, slug: string, description: string | null, missingInfo: Array<string>, workshop: { __typename: 'Workshop', id: string, name: string, slug: string, type: ActivityType, sessions: Array<{ __typename: 'Session', id: string, startsAt: DateTime }> } | null, picture: { __typename: 'ActivityPicture', id: string, medium: string, large: string } | null, presenters: Array<{ __typename: 'Person', bio: string, pronouns: string | null, id: string, name: string, picture: { __typename: 'ProfilePicture', large: string, id: string, small: string } | null, user: { __typename: 'User', id: string, email: string, permissions: Array<Permission> } | null, city: { __typename: 'Placename', id: string, name: string, traditionalName: string | null } | null, country: { __typename: 'Placename', id: string, name: string, traditionalName: string | null } | null }>, sessions: Array<{ __typename: 'Session', id: string, startsAt: DateTime, endsAt: DateTime, capacity: number | null, venue: { __typename: 'Venue', id: string, room: string | null, building: string } | null }> };
